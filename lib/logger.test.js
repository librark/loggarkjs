...
test('adds the provided logging labels to its final output', () => {
  const { mockGlobal } = setup()
  mockGlobal.LOGLEVEL = 'debug'
  const labels = { correlationId: 'ABCD1234', interactor: 'Informer' }
...
test('supports including static labels', () => {
  Logger.labels = () => {
